...
def loadData(gold_networks, Rank_nums, names, speciess, results):
    ...
    rank_list, significant_gene_list = get_gene_ranking(gene_order_path, low_express_gene_list, Rank_num,
                                                        rank_path + Rank_file_name, False)
    ...
    gold_pair_record, gold_score_record, unique_gene_list = get_filtered_gold(gold_network_path, rank_list,
                                                                              rank_path + Rank_file_name, True)
    # print("gold_pair_record",gold_pair_record)
    #
